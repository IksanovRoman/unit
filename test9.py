           ...
           messagebox.showinfo('Отказано', 'Вы не заполнили все поля')
            ...
            if k: #если в 1,2 и 3 поле числа, то заходим
                ...
                if n==1 or cust == 0 or tool == 0: #если ID не уникальный, или если в других таблицах таких значений нет, то ошибка
                    messagebox.showinfo('Отказано', 'Ошибка! Проверьте правильность ввода.\nID должно быть уникальным\nID заказчика должно быть в таблице заказчиков\nID средства защиты должно быть в таблице средств защиты.')
...
def update_licenses_table():
    ...
    def update_licenses_check_id():
        ...
        if k==1 and n==0:
            ...
            #данная кнопка добавит данные в табличку
            btn1 = Button(app, text="Изменить", command=update_licenses_id, bg="#FF7F27", font=("Arial", 12, "bold"))
            btn1.grid(column=1,row=32, sticky="E")
            btn2 = Button(app, text="Изменить все поля", command=update_licenses, bg="#FF7F27", font=("Arial", 12, "bold"))
            btn2.grid(column=1,row=33, sticky="E")
            #btn = Button(app, text="Изменить", command=update_licenses_three, bg="#FF7F27", font=("Arial", 12, "bold"))
            #btn.grid(column=1,row=34, sticky="E")
            #btn = Button(app, text="Изменить", command=update_licenses_four, bg="#FF7F27", font=("Arial", 12, "bold"))
            #btn.grid(column=1,row=35, sticky="E")
            #btn = Button(app, text="Изменить", command=update_licenses_five, bg="#FF7F27", font=("Arial", 12, "bold"))
            #btn.grid(column=1,row=36, sticky="E")
            #btn = Button(app, text="Изменить", command=update_licenses_six, bg="#FF7F27", font=("Arial", 12, "bold"))
            #btn.grid(column=1,row=37, sticky="E")
            #btn = Button(app, text="Изменить", command=update_licenses_seven, bg="#FF7F27", font=("Arial", 12, "bold"))
            #btn.grid(column=1,row=38, sticky="E")
