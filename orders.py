...
w = int((app.winfo_screenwidth())/2)
h = int((app.winfo_screenheight())/2)
...
def tab1():
    ...
    #показать таблицу
    show_customer_table()
    frame1.photo = PhotoImage(file=r"C:\Users\Roman\Desktop\Python_new\postgresql\update.png") 
...
def tab2():
    ...
    show_tools_table()
    frame2.photo = PhotoImage(file=r"C:\Users\Roman\Desktop\Python_new\postgresql\update.png") 
...
def tab3():
    ...
    show_licenses_table()
    frame3.photo = PhotoImage(file=r"C:\Users\Roman\Desktop\Python_new\postgresql\update.png") 
